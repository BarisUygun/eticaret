            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title" style="padding-top: 50px">Son Eklenenler</h2>
                        <div class="product-carousel">
                            <?php $i=0; foreach($liste as $urun) {?>
                                <div class="single-product">
                                    ...
                                    <div class="product-carousel-price">
                                        ...
                                        <button style="background-color: rgb(70,70,70)" name="button" type="submit" onclick="return addBasket('<?php echo $urun['id']?>',this);" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Sepete Ekle</button>
                                    </div>
                                </div>
                            <?php
                                $i++;
