            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="latest-product">
                        <h2 class="section-title" style="padding-top: 50px">Elektronik</h2>
                        <?php $i=1; foreach($liste as $urun) {
                                ...
                                <div class="single-product" style="float: left;margin-top: 20px">
                                    <div class="product-f-image">
                                        ...
                                        <div class="product-hover">
                                            <a href="urundetay/?id=<?php echo $urun['id']?>" class="view-details-link"><i class="fa fa-link"></i> Detay</a>
                                        </div>
                                    </div>
